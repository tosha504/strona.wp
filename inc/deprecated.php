...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'thenewlook' ),
		__( 'Previous', 'thenewlook' ),
		__( 'Next', 'thenewlook' ),
		__( 'About:', 'thenewlook' ),
		__( 'Profile', 'thenewlook' ),
		__( 'Posts by', 'thenewlook' ),
		__( 'Permanent Link:', 'thenewlook' ),
		__( 'in', 'thenewlook' ),
		__( 'Edit', 'thenewlook' ),
	);
}
