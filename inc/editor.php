...
if ( ! function_exists( 'understrap_tiny_mce_before_init' ) ) {
	...
	function understrap_tiny_mce_before_init( $settings ) {
		...
		$style_formats = array(
			array(
				'title'    => __( 'Lead Paragraph', 'thenewlook' ),
				'selector' => 'p',
				'classes'  => 'lead',
				'wrapper'  => true,
			),
			array(
				'title'  => _x( 'Small', 'Font size name', 'thenewlook' ),
				'inline' => 'small',
			),
			array(
				'title'   => __( 'Blockquote', 'thenewlook' ),
				'block'   => 'blockquote',
				'classes' => 'blockquote',
				'wrapper' => true,
			),
			array(
				'title'   => __( 'Blockquote Footer', 'thenewlook' ),
				'block'   => 'footer',
				'classes' => 'blockquote-footer',
				'wrapper' => true,
			),
			array(
				'title'  => __( 'Cite', 'thenewlook' ),
				'inline' => 'cite',
			),
		);
